...
-- AlterTable
ALTER TABLE "AiConversation" ADD COLUMN IF NOT EXISTS IF NOT EXISTS "agentId" TEXT,
ADD COLUMN IF NOT EXISTS IF NOT EXISTS "tenantId" TEXT;

-- AlterTable
ALTER TABLE "AiToolCall" ADD COLUMN IF NOT EXISTS IF NOT EXISTS "agentId" TEXT,
ADD COLUMN IF NOT EXISTS IF NOT EXISTS "tenantId" TEXT;

-- AlterTable
ALTER TABLE "AiApiCall" ADD COLUMN IF NOT EXISTS IF NOT EXISTS "agentId" TEXT,
ADD COLUMN IF NOT EXISTS IF NOT EXISTS "tenantId" TEXT;

-- AlterTable
ALTER TABLE "KnowledgeSource" ADD COLUMN IF NOT EXISTS IF NOT EXISTS "tenantId" TEXT;

-- AlterTable
ALTER TABLE "VenueSession" ADD COLUMN IF NOT EXISTS IF NOT EXISTS "agentId" TEXT,
ADD COLUMN IF NOT EXISTS IF NOT EXISTS "tenantId" TEXT;

-- AlterTable
ALTER TABLE "BrowserProfile" ADD COLUMN IF NOT EXISTS IF NOT EXISTS "agentId" TEXT,
ADD COLUMN IF NOT EXISTS IF NOT EXISTS "tenantId" TEXT;

-- AlterTable
ALTER TABLE "AgentEpisode" ADD COLUMN IF NOT EXISTS IF NOT EXISTS "agentId" TEXT,
ADD COLUMN IF NOT EXISTS IF NOT EXISTS "tenantId" TEXT;

-- AlterTable
ALTER TABLE "AgentFact" ADD COLUMN IF NOT EXISTS IF NOT EXISTS "agentId" TEXT,
ADD COLUMN IF NOT EXISTS IF NOT EXISTS "tenantId" TEXT;

-- AlterTable
ALTER TABLE "AgentPlaybook" ADD COLUMN IF NOT EXISTS IF NOT EXISTS "agentId" TEXT,
ADD COLUMN IF NOT EXISTS IF NOT EXISTS "tenantId" TEXT;

-- AlterTable
ALTER TABLE "Mission" ADD COLUMN IF NOT EXISTS IF NOT EXISTS "agentId" TEXT,
ADD COLUMN IF NOT EXISTS IF NOT EXISTS "parentMissionId" TEXT,
ADD COLUMN IF NOT EXISTS IF NOT EXISTS "tenantId" TEXT;

-- AlterTable
ALTER TABLE "VenuePlaybook" ADD COLUMN IF NOT EXISTS IF NOT EXISTS "agentId" TEXT,
ADD COLUMN IF NOT EXISTS IF NOT EXISTS "tenantId" TEXT;
