...
const DOMAIN_RULES: DomainRule[] = [
  ...
  { domain: 'documents', test: /reporte|informe|\bpdf\b|excel|xlsx|word|docx|\bcsv\b|grafic|tabla|imagen|foto|export|descarg|archivo|documento/, categories: ['export'], tools: ['generatePdfReport', 'generateExcelReport', 'generateWordReport', 'generateCsvExport', 'generateChart', 'generateReportImage', 'generateTable', 'listArtifacts', 'cleanupArtifacts', 'getArtifactSpec', 'shareArtifact', 'listAttachableDocuments'] },
  { domain: 'messaging', test: /mensaje|whatsapp|\bsms\b|manda|envia|escribe|avisa|dile|contesta|respond|recordatorio|masivo|campa/, categories: ['communication'], tools: ['sendMessageToContact', 'sendBulkMessages', 'sendInboxMessage', 'draftReply', 'listInboxConversations', 'getConversationMessages', 'listCommitments', 'createCommitment', 'scheduleFollowUp', 'getPickupLocation', 'listAttachableDocuments', 'shareArtifact', 'listCampaigns', 'getCampaignStats', 'draftCampaignContent', 'createCampaignDraft', 'approveCampaign', 'draftSatisfactionSurvey', 'draftCollectionReminders', 'notifyDelayedDeliveries'] },
  ...
  { domain: 'knowledge', test: /manual|politic|procedim|biblioteca|conocimient|ficha|garantia|instalaci|especificaci|que dice/, categories: ['knowledge'], tools: ['searchKnowledgeLibrary', 'listAttachableDocuments'] },
