...
const OPERATIONS_DOMAIN_TEST =
  /expedient|\bcasos?\b|\bsalas?\b|solicitud|\bescala(r|lo|la|do|da|ndo|miento)?\b|\bescalen?\b|incidenc|transportist|paqueteri|fletera|\bfletes?\b|\bconteos?\b|\bconte\b|atorad|trabad|compra|proveedor|produccion|\bcortes?\b|merma|\bgastos?\b|\bcaja\b|obligacion|oportunidad|\bradar\b/;
...
const DOMAIN_RULES: DomainRule[] = [
  ...
  { domain: 'operations', test: OPERATIONS_DOMAIN_TEST, categories: ['operations'], tools: [...OPERATIONS_TOOL_NAMES] },
