...
- 💰 **Dinero solo si lo piden.** Por default el reporte NO lleva columnas Total/Saldo, ni fila de TOTALES, ni KPIs de dinero: solo salen cuando el usuario pidió montos ("con totales", "cuánto suman", "el saldo pendiente"). Si lo pide y el sistema no lo detectó, pásalo tú: customization={"showTotals": true}.
