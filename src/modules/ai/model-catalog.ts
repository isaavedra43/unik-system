...
export const MODEL_CATALOG: ModelInfo[] = [
  ...
  // ============================================================
  {
    ...
    label: 'GPT-5',
    power: 10,
    bestFor: 'Análisis profundo, cruces de documentos, reportes ejecutivos, lectura de fotos y manuscritos',
    contextWindow: 400_000,
    maxOutput: 128_000,
    speed: 'slow',
    costPer1M: { input: 1.25, output: 10.0 },
    capabilities: ['vision', 'tool_use', 'streaming', 'json_mode', 'reasoning'],
    description: 'El modelo de ChatGPT con razonamiento: piensa antes de responder, lee imágenes y manuscritos con precisión y sostiene tareas largas de varios pasos. Recomendado para las tareas complejas.',
    available: true,
  },
  {
    id: 'gpt-5-mini',
    ...
    label: 'GPT-5 Mini',
    power: 8,
    bestFor: 'Rutina con razonamiento ligero, extracción de documentos, resúmenes',
    contextWindow: 400_000,
    maxOutput: 128_000,
    speed: 'medium',
    costPer1M: { input: 0.25, output: 2.0 },
    capabilities: ['vision', 'tool_use', 'streaming', 'json_mode', 'reasoning'],
    description: 'Versión económica de GPT-5 con razonamiento. Mejor que GPT-4o-mini en precisión; buena opción para la rutina cuando no hay Canopy Wave.',
    available: true,
  },
  {
    id: 'gpt-5.1',
    ...
    label: 'GPT-5.1',
    power: 10,
    bestFor: 'Igual que GPT-5 con respuestas más naturales y razonamiento adaptativo',
    contextWindow: 400_000,
    maxOutput: 128_000,
    speed: 'slow',
    costPer1M: { input: 1.25, output: 10.0 },
    capabilities: ['vision', 'tool_use', 'streaming', 'json_mode', 'reasoning'],
    description: 'Revisión de GPT-5 (noviembre 2025). Usa "Detectar modelos de OpenAI" en el panel para confirmar que tu llave lo lista.',
    available: true,
  },
  {
    id: 'gpt-4o',
    ...
    description: 'Modelo multimodal rápido sin razonamiento previo. Bueno para consultas directas; para análisis, cruces de documentos y manuscritos usa GPT-5.',
    available: true,
  },
  {
    id: 'gpt-4o-mini',
  ...
  // ============================================================
  // OpenRouter (one key, every vendor; ids carry the vendor prefix)
  // ============================================================
  {
    ...
    power: 8,
    bestFor: 'Rutina diaria rápida y barata, agentes con herramientas, visión',
    contextWindow: 1_048_576,
    maxOutput: 65_536,
    speed: 'fast',
    costPer1M: { input: 0.3, output: 2.5 },
    capabilities: ['vision', 'tool_use', 'streaming', 'json_mode', 'reasoning'],
    description: 'Modelo rápido de Google vía OpenRouter. Contexto de 1M, tools y visión — el caballo de batalla barato para agentes.',
    available: true,
  },
  {
    ...
    power: 8,
    bestFor: 'Rutina con razonamiento ligero, extracción de documentos',
    contextWindow: 400_000,
    maxOutput: 128_000,
    speed: 'medium',
    costPer1M: { input: 0.25, output: 2.0 },
    capabilities: ['vision', 'tool_use', 'streaming', 'json_mode', 'reasoning'],
    description: 'GPT-5 Mini servido por OpenRouter. Útil como fallback cuando no hay crédito en el provider directo.',
    available: true,
  },
  {
    ...
    power: 10,
    bestFor: 'Análisis profundo, planes multi-paso, revisión de agentes',
    contextWindow: 1_000_000,
    maxOutput: 64_000,
    speed: 'medium',
    costPer1M: { input: 3.0, output: 15.0 },
    capabilities: ['vision', 'tool_use', 'streaming', 'json_mode', 'reasoning'],
    description: 'Claude Sonnet 4.5 vía OpenRouter — el tier fuerte para decisiones complejas del agente central.',
    available: true,
  },
  {
    ...
    power: 7,
    bestFor: 'Volumen alto muy barato: resúmenes, extracción, clasificación',
    contextWindow: 163_840,
    maxOutput: 65_536,
    speed: 'fast',
    costPer1M: { input: 0.2, output: 0.8 },
    capabilities: ['tool_use', 'streaming', 'json_mode'],
    description: 'Modelo abierto de DeepSeek vía OpenRouter. Muy barato para trabajo de fondo de alto volumen.',
    available: true,
  },
  {
    ...
    power: 9,
    bestFor: 'Agente con herramientas, análisis largo',
    contextWindow: 256_000,
    maxOutput: 8_192,
    speed: 'medium',
    costPer1M: { input: 0.6, output: 2.5 },
    capabilities: ['tool_use', 'streaming', 'reasoning'],
    description: 'Kimi K2 de Moonshot vía OpenRouter — orientado a agentes y tool use.',
    available: true,
  },
  {
    id: 'openai/gpt-5.2',
    ...
    power: 10,
    bestFor: 'Razonamiento pesado, análisis complejo, documentos difíciles',
    contextWindow: 400_000,
    maxOutput: 128_000,
    speed: 'slow',
    costPer1M: { input: 1.75, output: 14.0 },
    capabilities: ['vision', 'tool_use', 'streaming', 'json_mode', 'reasoning'],
    description: 'El modelo flagship de OpenAI vía OpenRouter. Máximo razonamiento para análisis, conciliaciones y reportes complejos.',
    available: true,
  },
  {
    ...
    power: 10,
    bestFor: 'El análisis más profundo: auditorías, planes largos, decisiones difíciles',
    contextWindow: 200_000,
    maxOutput: 64_000,
    speed: 'slow',
    costPer1M: { input: 5.0, output: 25.0 },
    capabilities: ['vision', 'tool_use', 'streaming', 'json_mode', 'reasoning'],
    description: 'Claude Opus 4.5 vía OpenRouter — el tier máximo de Anthropic para cuando la respuesta tiene que salir bien a la primera.',
    available: true,
  },
  {
    id: 'x-ai/grok-4',
    ...
    power: 10,
    bestFor: 'Razonamiento pesado con visión, estilo directo',
    contextWindow: 256_000,
    maxOutput: 64_000,
    speed: 'medium',
    costPer1M: { input: 3.0, output: 15.0 },
    capabilities: ['vision', 'tool_use', 'streaming', 'json_mode', 'reasoning'],
    description: 'Grok 4 de xAI vía OpenRouter — razonamiento fuerte con visión y tools; respuestas directas sin rodeos.',
    available: true,
  },
  {
    ...
    power: 10,
    bestFor: 'Análisis profundo con contexto enorme y visión',
    contextWindow: 1_048_576,
    maxOutput: 65_536,
    speed: 'medium',
    costPer1M: { input: 2.0, output: 12.0 },
    capabilities: ['vision', 'tool_use', 'streaming', 'json_mode', 'reasoning'],
    description: 'Gemini 3 Pro vía OpenRouter — contexto de 1M y razonamiento fuerte; ideal para cruzar documentos largos con datos del ERP.',
    available: true,
  },
