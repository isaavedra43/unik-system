...
const STATUS_MAP: Record<string, ProductStatusConfig> = {
...
export function getProductStatusLabel(raw: string | null | undefined): string {
  return getProductStatusConfig(raw).label;
}

export function getProductStatusOptions(): { value: string; label: string }[] {
