...
export const VOICE_PERMISSIONS: PermissionDefinition[] = [
  {
    ...
    description: 'Permite llamadas internas y externas con copiloto de IA, pausa y grabación con controles visibles',
  },
  {
    key: 'calls.supervise',
    group: 'Telefonía',
    label: 'Supervisar llamadas',
    description: 'Permite listar, escuchar, leer transcripciones e intervenir en llamadas de los equipos permitidos',
  },
  {
    key: 'calls.admin',
    group: 'Telefonía',
