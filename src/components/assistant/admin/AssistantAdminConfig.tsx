...
const AGENT_SETTING_FIELDS: Array<{ key: string; label: string; type: 'number' | 'string' | 'boolean' | 'list' | 'textarea' | 'password'; hint?: string }> = [
  ...
  { key: 'venueEnabled', label: 'Computadora virtual (Daytona)', type: 'boolean', hint: 'Sandbox desechable para browser + exec. Requiere DAYTONA_API_KEY; el navegador y el aprovisionamiento van incluidos.' },
