...
import { listAllApiCalls } from '@/modules/ai/ai-admin-service';
...
export async function GET(req: NextRequest) {
  ...
  const deployment = searchParams.get('deployment') ?? undefined;
  ...
  const result = await listAllApiCalls({ deployment, userId, success, page, pageSize, dateFrom, dateTo });
