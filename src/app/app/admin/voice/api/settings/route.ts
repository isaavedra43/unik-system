...
import { getVoiceAgentHealth } from '@/modules/voice/voice-agent-service';
import { getVoiceSettings, updateVoiceSettings } from '@/modules/voice/voice-settings';
...
async function payload() {
  ...
  return {
    ...
    status: {
      ...
      twilioWebhookConfigured: twilioConfigured,
      voiceAgent: getVoiceAgentHealth(),
    },
  };
}
