...
import { getLatestEstimatesSyncRun, getActiveEstimatesSyncRun } from '@/modules/integrations/zoho/estimates-sync';
...
export async function GET() {
  ...
  const [latestRun, activeRun] = await Promise.all([getLatestEstimatesSyncRun(), getActiveEstimatesSyncRun()]);
