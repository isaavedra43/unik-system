...
import {
  NormalizationAlreadyRunningError, normalizePendingBillSnapshots,
} from '@/modules/bills/bills-normalizer';
...
export async function POST(request: Request) {
  ...
  try {
    const result = await normalizePendingBillSnapshots({ limit });
    ...
    console.error('internal bills normalize error', error);
