...
import {
  NormalizationAlreadyRunningError, normalizePendingInvoiceSnapshots,
} from '@/modules/invoices/invoices-normalizer';
...
export async function POST(request: Request) {
  ...
  try {
    const result = await normalizePendingInvoiceSnapshots({ limit });
    ...
    console.error('internal invoices normalize error', error);
