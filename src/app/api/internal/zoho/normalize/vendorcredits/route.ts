...
import {
  NormalizationAlreadyRunningError, normalizePendingVendorCreditSnapshots,
} from '@/modules/vendor-credits/vendor-credits-normalizer';
...
export async function POST(request: Request) {
  ...
  try {
    const result = await normalizePendingVendorCreditSnapshots({ limit });
    ...
    console.error('internal vendor credits normalize error', error);
